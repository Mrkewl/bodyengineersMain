...
import '../../screen/health_stats/widget/detail/step_detail_chart.dart';
...
class StepStats extends StatefulWidget {
  @override
  _StepStatsState createState() => _StepStatsState();
}

class _StepStatsState extends State<StepStats> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    watchDataList = args['watchDataList'] ?? [];
    watchDataList =
        watchDataList.where((element) => element.stepsTaken != null).toList();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text(
                'Walking is a great way to get more exercise and get fit, and it doesn\'t require a lot of preparation. This is a good way to get out of being sedentary. You don\'t need lessons, equipment, or expensive clothing to walk your way to a healthier you!',
                style: TextStyle(
                  color: theme.currentTheme() == ThemeMode.dark
                      ? Colors.white
                      : Colors.black38,
