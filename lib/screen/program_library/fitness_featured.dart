...
class FitnessFeatured extends StatefulWidget {
  @override
  _FitnessFeaturedState createState() => _FitnessFeaturedState();
}

class _FitnessFeaturedState extends State<FitnessFeatured> {
